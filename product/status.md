...
**Current stage:** 8 of 10 — Quality (in progress)
**Progress:** `[#######---]` ~75%
...
| 8 | Quality ⛔ | qa-engineer | 🔄 in progress | `08-quality/test-report.md` |
...
1. Nothing gate-blocking — QA is running. Next gate: ⛔ Quality (GO/NO-GO).
